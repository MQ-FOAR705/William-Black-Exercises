...
\newpage
\section{27.08.19 - Data Carpentry}
...
\subsubsection{\underline{GUI/CLI Confusion Errors:}}\label{error:er12}
\begin{itemize}
...
\subsubsection{\underline{Shell: Command Not Found Errors:}}\label{error:er13}
\begin{itemize}
...
\begin{enumerate}
    \item GUI/CLI Confusion \ref{error:er12}
    \item Shell: Command Not Found \ref{error:er13}
\end{enumerate}
\end{document}
